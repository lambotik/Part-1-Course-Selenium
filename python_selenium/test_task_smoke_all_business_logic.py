...
print('Name Product #2 is:', value_product_2)
...
print('Price Product #2 is:', value_price_product_2)
...
print('Name Product #2 in Cart is:', cart_value_product_2)
assert value_product_2 == cart_value_product_2
print('Name Product #2 in Cart is: GOOD')
...
print('Price Product #2 in Cart is:', cart_value_price_product_2)
assert value_price_product_2 == cart_value_price_product_2
print('Price Product #2 in Cart is: GOOD')
...
print('Name Product #2 in Finish is:', finish_value_product_2)
assert value_product_2 == finish_value_product_2
print('Name Product #2 in Finish is: GOOD')
...
print('Price Product #2 in Finish is:', finish_value_price_product_2)
assert value_price_product_2 == finish_value_price_product_2
print('Price Product #2 in Finish is: GOOD')

"""Считаем сумму двух продуктов"""
sum_product_1 = finish_value_price_product_1
print(float(sum_product_1[1:]))
sum_product_2 = finish_value_price_product_2
print(float(sum_product_2[1:]))
total_sum = float(sum_product_1[1:]) + float(sum_product_2[1:])
print(total_sum)
...
value_summary_price = summary_price.text
print(value_summary_price)
item_total = 'Item total: ' + '$' + str(total_sum)
print('Результат проверки', item_total)
